...
#def count_lines(filename):
 #   lines = 0
  #  with open(filename,encoding="utf-8").read().split('\n')[:-1] as f:
   #     for line in f:
    #        lines = lines + 1
...
def process_data():
    ...
    for word in qtokenized:
        qtokenized_count = qtokenized_count + 1
    for token in atokenized:
        atokenized_count = atokenized_count +1
    print ("The number of unique tokens in questions ",qtokenized_count)
    print("The number of unique tokens in answers",atokenized_count)
